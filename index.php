<?php
	$page_layout = $_GET['page_layout'] ?? 'FASHION';
	$page_layout = strtoupper($page_layout);
...
<head>
	...
	<title><?php echo $page_layout; ?></title>
	...
	<div id="page">
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="index.php">Fashion</a></div>
						</div>
		...
		if(isset($_GET['page_layout'])) {
			switch($_GET['page_layout']) {
				...
				case 'complete': include('complete.php'); break;
			...
			<div class="container">
				<div class="row row-pb-md">
					...
					<div class="col-md-2 colorlib-widget">
						...
						<p>
							<ul class="colorlib-footer-links">
								<li><a href="index.php?page_layout=about">Về chúng tôi</a></li>
